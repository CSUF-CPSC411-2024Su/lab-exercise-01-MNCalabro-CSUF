...
// TODO: Create another initializer that accepts a String parameter called "name" and an Int parameter called "age". Assign the parameter values to the corresponding properties of the class.
